...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/asia.svg
  SvgGenImage get asia => const SvgGenImage('assets/icons/asia.svg');

  /// File path: assets/icons/ayal.svg
  SvgGenImage get ayal => const SvgGenImage('assets/icons/ayal.svg');

  /// File path: assets/icons/ayal2.svg
  SvgGenImage get ayal2 => const SvgGenImage('assets/icons/ayal2.svg');

  /// File path: assets/icons/erkek.svg
  SvgGenImage get erkek => const SvgGenImage('assets/icons/erkek.svg');

  /// File path: assets/icons/erkek2.svg
  SvgGenImage get erkek2 => const SvgGenImage('assets/icons/erkek2.svg');

  /// List of all assets
  List<SvgGenImage> get values => [asia, ayal, ayal2, erkek, erkek2];
}
